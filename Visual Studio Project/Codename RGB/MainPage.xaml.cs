...
namespace Codename_RGB
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            // Green Slider Value was Changed
        ...
        private void blackoutButton_Click(object sender, RoutedEventArgs e)
        {
            // The blackout button was clicked. Set all of the sliders and their vars to 0.
            rSlider.Value = 0;
            gSlider.Value = 0;
            bSlider.Value = 0;
        }
